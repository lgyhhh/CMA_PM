...
public class Certificate_Modify extends AppCompatActivity {
    Toolbar toolbar;
    TextView tv;
    TextView filename;
    private File output;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.certificate__modify);
        Intent intent=getIntent();
        certificate=(Certificate) intent.getSerializableExtra("document");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {//4.4以后
                ...
                filename.setText(units[units.length-1]);
                Log.d("textname",units[units.length-1]);
                Toast.makeText(Certificate_Modify.this, path+"222222", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void upload(){
        ...
        if((s1 == null || s1.equals("")))
            isfull=false;
        if(isfull){
            AlertDialog.Builder dialog = new AlertDialog.Builder(Certificate_Modify.this);
            ...
            dialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    progressDialog = new ProgressDialog(Certificate_Modify.this);
            ...
            dialog.setNegativeButton("取消", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Toast.makeText(Certificate_Modify.this, "你仍旧可以修改！", Toast.LENGTH_SHORT).show();
                }
            });
            dialog.show();
        } else {
            Toast.makeText(Certificate_Modify.this, "请全部填满", Toast.LENGTH_SHORT).show();
        }
    }

    public void postJson(Long id,String s){
        String address = "\thttp://119.23.38.100:8080/cma/Certificate/modifyOne";
        ...
        HttpUtil.sendOkHttpWithMultipartBody(address,requestBody.build(),new okhttp3.Callback(){
                ...
                if(code == 200 && msg.equals("成功")) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(Certificate_Modify.this, "修改成功！", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            progressDialog.dismiss();
                            Toast.makeText(Certificate_Modify.this, "修改失败，文档已存在！", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
            ...
            public void onFailure(Call call,IOException e){
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        progressDialog.dismiss();
                        Toast.makeText(Certificate_Modify.this, "修改失败！", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });

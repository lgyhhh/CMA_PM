...
public class ManageReviewOne_Add extends AppCompatActivity  implements View.OnClickListener  {
        Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manage_review_one__add);
    ...
    public void OnSave()
    {
        ...
        if((s1==null||s1.equals(""))||!file.exists())
            Toast.makeText(ManageReviewOne_Add.this,"请全部填满",Toast.LENGTH_SHORT).show();
        else
        {
            postSave(s1);
        }
    ...
    private void postSave(String name){
        ...
        final ProgressDialog progressDialog=new ProgressDialog(ManageReviewOne_Add.this);
        ...
        final Request request = new Request.Builder().url("http://119.23.38.100:8080/cma/ManagementReview/addOneFile").post(body).build();
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
                ...
                if(code == 200 && msg.equals("成功")) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(ManageReviewOne_Add.this, "提交成功！", Toast.LENGTH_SHORT).show();
                        }
                    });
                    finish();
                }
            ...
            public void onFailure(Call call,IOException e){
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        progressDialog.dismiss();
                        Toast.makeText(ManageReviewOne_Add.this, "提交失败！", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });

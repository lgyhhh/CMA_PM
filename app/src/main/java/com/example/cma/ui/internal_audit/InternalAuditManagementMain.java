...
import com.example.cma.adapter.internal_audit.InternalAuditManagementAdapter;
...
public class InternalAuditManagementMain extends AppCompatActivity {

    public List<InternalAuditManagement> dangAns = new ArrayList<InternalAuditManagement>();
    private InternalAuditManagementAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.internal_audit_management_main);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,
                ...
                AlertDialog.Builder builder=new AlertDialog.Builder(InternalAuditManagementMain.this);
                builder.setMessage("确定删除?");
                builder.setTitle("提示");
                builder.setPositiveButton("确定", new DatePickerDialog.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        InternalAuditManagement temp=(InternalAuditManagement)listView.getItemAtPosition(position);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                InternalAuditManagement d=(InternalAuditManagement) listView.getItemAtPosition(i);
                Intent intent=new Intent(InternalAuditManagementMain.this,InternalAuditDocument_Main.class);
    ...
    public void postDelete(long year){
        ...
        Request request = new Request.Builder()
                .url("http://119.23.38.100:8080/cma/InternalAuditManagement/deleteOne")//url的地址
                .post(requestBody)
                .build();
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(InternalAuditManagementMain.this, "删除失败！", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(InternalAuditManagementMain.this, "删除成功！", Toast.LENGTH_SHORT).show();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            // 指定访问的服务器地址，后续在这里修改
                            .url("http://119.23.38.100:8080/cma/InternalAuditManagement/getAll")
                            .build();
    ...
    private void parseJSONWithGSON(String jsonData) {
        ...
        dangAns = gson.fromJson(string, new TypeToken<List<InternalAuditManagement>>(){}.getType());
    ...
    private void showResponse() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                // 在这里进行UI操作，将结果显示到界面上
                adapter = new InternalAuditManagementAdapter(InternalAuditManagementMain.this, R.layout.internal_management_item, dangAns);

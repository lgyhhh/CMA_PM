...
public class StaffResigning_Main extends AppCompatActivity {
    static public List<StaffResigning> dangAns=new ArrayList<StaffResigning>();

    private StaffResigningAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.staff_resigning__main);
        initView();
        initDangan();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent=new Intent(StaffResigning_Main.this,StaffResigning_Modify.class);
                StaffResigning d=(StaffResigning) listView.getItemAtPosition(i);
                Log.d("aaaaaaa",d.getName());
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(StaffResigning_Main.this,StaffResigning_Add.class);
                startActivity(intent);
            }
        });
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            // 指定访问的服务器地址，后续在这里修改
                            .url("http://119.23.38.100:8080/cma/StaffResigning/getAll")
    ...
    private void parseJSONWithGSON(String jsonData) {
        ...
        Gson gson = new Gson();
        dangAns = gson.fromJson(jsonData, new TypeToken<List<StaffResigning>>() {}.getType());
...
//        Log.d("id",temp.getFileId());
    ...
    private void showResponse() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                // 在这里进行UI操作，将结果显示到界面上
                adapter=new StaffResigningAdapter(StaffResigning_Main.this,R.layout.listview_item,dangAns);
                listView.setAdapter(adapter);
            }
        });
    }
